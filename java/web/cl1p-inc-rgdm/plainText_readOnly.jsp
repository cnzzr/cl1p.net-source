   ...
   <table width="100%">
    <tr>
     <td width="100%" height="80%">
        ...
        %>
<textarea name="ctrlcv" cols="80" rows="<%= clip.getRows() %>" class="ohw"><%= clip.getValue() %></textarea>
     </td>
    </tr>
   </table>
  </td>
...
<tr>
 ...
 <td><input type="submit" id="editButton" value="Edit"><input type="button" value="Print" onclick="printCl1p();"></td>
</tr>
</table>
</div>
</td></tr></table>
