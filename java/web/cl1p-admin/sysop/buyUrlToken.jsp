    ...
    try {
        try {
            ...
            if (gogo != null) {
                ...
                checkoutId = "" + sa.queueUrlToBuy(uri, null, con);

            }
            if(checkoutValue != null){
                sa.completeUrlTokenPurchase(Integer.parseInt(checkoutValue), item,  email, con, config.getServletContext());
            }
...
<form method="post">
    <input type="hidden" name="gogogo" value="GO">
    <input type="hidden" name="gogo" value=""><br>
